...
%---------------------------------------------------------
  \cventry
    ...
    {Utilização de Técnicas Avançadas de Análise de Dados (Big Data) e Inovação para Apoio ao Planejamento e Desenvolvimento de Políticas em Saúde - PROADI-SUS/Hospital Israelita Albert Einstein (\url{https://hospitais.proadi-sus.org.br/projetos/24/big-data})} % Organization
